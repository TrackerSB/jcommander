...
import bayern.steinbrecher.jcommander.internal.Sets;
  ...
  public static List<Parameterized> parseArg(Object arg) {
    ...
    for(Class<?> cls : types) {
      ...
      for (Field f : cls.getDeclaredFields()) {
        Annotation annotation = f.getAnnotation(bayern.steinbrecher.jcommander.Parameter.class);
        ...
        if (annotation != null) {
          result.add(new Parameterized(new WrappedParameter((bayern.steinbrecher.jcommander.Parameter) annotation), null,
                  f, null));
      ...
      for (Method m : cls.getDeclaredMethods()) {
        ...
        Annotation annotation = m.getAnnotation(bayern.steinbrecher.jcommander.Parameter.class);
