...
import bayern.steinbrecher.jcommander.converters.DefaultListConverter;
import bayern.steinbrecher.jcommander.converters.EnumConverter;
import bayern.steinbrecher.jcommander.converters.IParameterSplitter;
import bayern.steinbrecher.jcommander.converters.NoConverter;
import bayern.steinbrecher.jcommander.converters.StringConverter;
import bayern.steinbrecher.jcommander.internal.Console;
import bayern.steinbrecher.jcommander.internal.DefaultConsole;
import bayern.steinbrecher.jcommander.internal.DefaultConverterFactory;
import bayern.steinbrecher.jcommander.internal.JDK6Console;
import bayern.steinbrecher.jcommander.internal.Lists;
import bayern.steinbrecher.jcommander.internal.Maps;
import bayern.steinbrecher.jcommander.internal.Nullable;
import bayern.steinbrecher.jcommander.FuzzyMap.IKey;
import bayern.steinbrecher.jcommander.converters.*;
import bayern.steinbrecher.jcommander.internal.*;
...
public class JCommander {
    ...
    static class MainParameter {
         ...
         */
        private bayern.steinbrecher.jcommander.Parameter annotation;
    ...
    /**
     * @param object The arg object expected to contain {@link bayern.steinbrecher.jcommander.Parameter} annotations.
     */
     ...
     *
     * @param object The arg object expected to contain {@link bayern.steinbrecher.jcommander.Parameter}
    ...
    private void validateOptions() {
        ...
        if (mainParameter != null && mainParameter.description != null) {
            ...
            if (arity != bayern.steinbrecher.jcommander.Parameter.DEFAULT_ARITY) {
    ...
    private void addDescription(Object object) {
        ...
        for (Parameterized parameterized : parameterizeds) {
            ...
            if (wp != null && wp.getParameter() != null) {
                bayern.steinbrecher.jcommander.Parameter annotation = wp.getParameter();
                //
                // @Parameter
                //
                bayern.steinbrecher.jcommander.Parameter p = annotation;
                if (p.names().length == 0) {
    ...
    public static class Builder {
         ...
         * will parse arguments into.
         *
         * @param o The arg object expected to contain {@link bayern.steinbrecher.jcommander.Parameter}
         * annotations. If <code>object</code> is an array or is {@link Iterable},
         * the child objects will be added instead.
         */
    ...
    public void addConverterFactory(final IStringConverterFactory converterFactory) {
        addConverterInstanceFactory(new IStringConverterInstanceFactory() {
            ...
            @Override
            public IStringConverter<?> getConverterInstance(bayern.steinbrecher.jcommander.Parameter parameter, Class<?> forType, String optionName) {
    ...
    private IStringConverter<?> findConverterInstance(bayern.steinbrecher.jcommander.Parameter parameter, Class<?> forType, String optionName) {
